...
namespace implemented
{
    ...
    public:
        ...
        void RotateFirstPerson_OX(float angle)
        {
            ...
            auto rot = glm::rotate(glm::mat4(1.0f), angle, right);
            forward = rot * glm::vec4(forward, 0.0f);
            up = rot * glm::vec4(up, 0.0f);
        ...
        void RotateFirstPerson_OY(float angle)
        {
            ...
            auto rot = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0.0f, 1.0f, 0.0f));
        ...
        void RotateFirstPerson_OZ(float angle)
        {
            ...
            auto rot = glm::rotate(glm::mat4(1.0f), angle, forward);
            right = rot * glm::vec4(right, 0.0f);
            up = rot * glm::vec4(up, 0.0f);
